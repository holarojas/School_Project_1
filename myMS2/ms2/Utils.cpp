...
namespace sdds {
   ...
   {
       bool exit = false;
       char input = 0; //Using char so I can get isdigit() results properly
       int result = 0;
       if (prompt != nullptr) {
           cout << prompt;
           do {      
               ...
               if (input > 0 && isdigit(input)) {
                   result = input - 48; //To get the specific char value of the digit and no the ASCII dec equivalent
                   exit = true;
               }
               else {
